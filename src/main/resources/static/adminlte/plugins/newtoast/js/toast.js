...
var toastrsuccess = function (context) {
    base(context,'#4EA44E')
}
var toastrinfo = function (context) {
    base(context,'rgba(7,17,27,0.66)')
}
var toastrwarning = function (context) {
    base(context,'#EFBF66')
}
var toastrerror = function (context) {
    base(context,'#CC4532')
}

function base(context,color) {
    $('body').toast({
        position:'fixed',
        content:context,
        duration:2000,
