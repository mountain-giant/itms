...
$(function () {
    ...
    $('#questionTable').bootstrapTable({
        url: '/question/myAssigne.bms?projectId='+localStorage.getItem("stotage_project_id"),
        ...
        columns: [
            ...
            {
                field: 'questionStatus', title: '状态', width: 70, align: 'center',
                formatter: function (value, row, index) {
                    if (value == 1) {
            ...
            {
                field: 'questionLevel', title: '优先级', width: 70, align: 'center',
                formatter: function (value, row, index) {
                    if (value == 1) {
            ...
            {
                field: 'questionStage', title: '阶段', width: 50, align: 'center',
                formatter: function (value, row, index) {
                    if (value == 1) {
