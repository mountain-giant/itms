...
/**
 * Describe :
 * Created by LY on 2018/6/8 10:14.
 * Update reason :
 * Updated by LY on 2018/6/8 10:14.
...
public class PingUtils {
    ...
    public static boolean ping(String ipAddress, int pingTimes, int timeOut) throws IOException {
        ...
        try (BufferedReader in = new BufferedReader(new InputStreamReader(p.getInputStream()))) {   // 执行命令并获取输出  
